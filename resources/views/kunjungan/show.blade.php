...
<head>
    ...
    <style>
        ...
        .soap-section { border-left: 4px solid #a1bfbc; padding-left: 12px; margin-bottom: 16px; }
                            ...
                            <div class="card-body">
                                <table class="table table-sm table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td>: <span class="badge badge-info">{{ strtoupper($kunjungan->jenis_pembayaran) }}</span></td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="col-md-3 col-6 mb-2">
                                    <div class="card border-left-success">
                                        <div class="card-body py-2 px-3">
                                            ...
                                            <div class="h5 mb-0">{{ $p->respirasi ? $p->respirasi . ' x/mnt' : '-' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
