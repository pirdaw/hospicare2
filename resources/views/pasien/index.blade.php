                        ...
                        <div class="card-header py-3 d-flex align-items-center justify-content-between">
                            ...
                            <form method="GET" action="{{ route('pasien.index') }}" class="d-flex" style="gap:8px">
                                <input type="text" name="search" value="{{ request('search') }}"
                                    class="form-control form-control-sm" placeholder="Cari nama / NIK / no HP..."
                                    style="width:250px">
                                                    ...
                                                    <td>
                                                        @if($pasien->jenis_kelamin === 'L')
                                                            <span class="badge badge-primary"><i
                                                                    class="fas fa-mars mr-1"></i>Laki-laki</span>
                                                        @else
                                                            <span class="badge" style="background-color:#e91e8c;color:#fff;"><i
                                                                    class="fas fa-venus mr-1"></i>Perempuan</span>
                                                        @endif
                                                    </td>
