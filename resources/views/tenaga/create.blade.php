...
<head>
    ...
    <style>
        ...
        .section-title {
            ...
            border-bottom: 2px solid #a1bfbc;
            padding-bottom: 6px;
            margin-bottom: 16px;
        }
    </style>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('tenaga-kesehatan.store') }}" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama"
                                                ...
                                                value="{{ old('nama') }}" placeholder="dr. Nama Lengkap" autofocus>
                                            @error('nama')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email"
                                                ...
                                                value="{{ old('email') }}" placeholder="email@hospicare.id">
                                            @error('email')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="alamat"
                                                ...
                                                value="{{ old('alamat') }}" placeholder="Jl. Contoh No. 1">
                                            @error('alamat')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                {{-- Bagian Profil Medis --}}
                                <div class="section-title"><i class="fas fa-stethoscope mr-1"></i> Data Profil Medis
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="jenis"
                                                ...
                                                <option value="dokter" {{ old('jenis') === 'dokter' ? 'selected' : '' }}>
                                                    Dokter</option>
                                                <option value="perawat" {{ old('jenis') === 'perawat' ? 'selected' : '' }}>Perawat</option>
                                                <option value="bidan" {{ old('jenis') === 'bidan' ? 'selected' : '' }}>
                                                    Bidan</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="no_str"
                                                ...
                                                value="{{ old('no_str') }}" placeholder="Nomor STR">
                                            @error('no_str')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
