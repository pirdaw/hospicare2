                        ...
                        <div class="card-body py-3">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <span
                                        class="text-muted ml-2">{{ $pemeriksaan->kunjungan->pasien->nik ?? '' }}</span>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <div class="col-md-3 col-6">
                                        <div class="vital-card mb-3">
                                            ...
                                            <input type="number" name="respirasi" min="0" max="100"
                                                ...
                                                placeholder="20">
                                            @error('respirasi') <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="card soap-card soap-S p-3">
                                            ...
                                            @error('subjective') <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="card soap-card soap-O p-3">
                                            ...
                                            @error('objective') <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="card soap-card soap-A p-3">
                                            ...
                                            @error('assessment') <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
