...
<head>
    ...
    <style>
        ...
        .soap-section { border-left: 4px solid #a1bfbc; padding: 12px 16px; margin-bottom: 16px; background: #fafafa; border-radius: 0 6px 6px 0; }
        ...
        .vital-box { text-align: center; padding: 16px; background: #f8f9fa; border-radius: 8px; }
        .vital-value { font-size: 24px; font-weight: 700; }

        @media print {
            .sidebar, .topbar, .btn, form, #sidebarToggle { display: none !important; }
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div>
                        ...
                        <a href="{{ route('kunjungan.show', $pemeriksaan->kunjungan) }}" class="btn btn-secondary btn-sm">
                            ...
                            <div class="col-md-6">
                                <table class="table table-sm table-borderless">
                                    <tr>
                                        ...
                                        <td>: <strong>{{ $pemeriksaan->kunjungan->pasien->nama ?? '-' }}</strong></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>: {{ $pemeriksaan->kunjungan->pasien->jenis_kelamin === 'L' ? 'Laki-laki' : 'Perempuan' }}</td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="col-md-6">
                                <table class="table table-sm table-borderless">
                                    <tr>
                                        ...
                                        <td>: {{ $pemeriksaan->poli->nama_poli ?? $pemeriksaan->kunjungan->poli->nama_poli ?? '-' }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>: {{ $pemeriksaan->tenagaKesehatan->user->nama ?? '-' }}
                                            <span class="text-muted">({{ ucfirst($pemeriksaan->tenagaKesehatan->jenis ?? '') }})</span>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="soap-section soap-O">
                                    <div class="font-weight-bold text-success mb-2">
                                        O — Objective
                                        <small class="text-muted font-weight-normal ml-1">(Pemeriksaan Fisik)</small>
                                    </div>
